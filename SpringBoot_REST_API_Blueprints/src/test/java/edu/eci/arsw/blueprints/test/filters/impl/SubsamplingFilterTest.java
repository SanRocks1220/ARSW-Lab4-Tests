...
import edu.eci.arsw.blueprints.services.filters.impl.SubsamplingFilter;
...
public class SubsamplingFilterTest {
    ...
    public void ShouldNotRemovePoints() {
        ...
        Point[] originalPoints=new Point[]{new Point(0, 0)};
        Blueprint bp=new Blueprint("maria", "thepaint",originalPoints);

        Point[] finalPoints=new Point[]{new Point(0, 0)};
